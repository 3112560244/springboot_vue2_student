...
<!--      头部-->
      <el-header style="text-align: left; font-size: 12px; border-bottom: 1px solid antiquewhite; line-height: 60px; display: flex">
...
<!--        //主页页签显示当前页面的路径-->
        ...
        <div style="margin: 10px 0">
          ...
          <el-input  style="width: 200px" placeholder="请输入邮箱"  suffix-icon="el-icon-message"class="mr-5"></el-input>
          <el-input  style="width: 200px" placeholder="请输入地址"  suffix-icon="el-icon-position" class="mr-5"></el-input>
...
export default {
  ...
  methods:{
    ...
    load(){
      fetch("http://localhost:9090/user/page?pageNum="+this.pageNum+"&pageSize="+this.pageSize+"&userName="+this.selectName).then(res=>res.json()).then(res =>{
